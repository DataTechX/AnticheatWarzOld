...
void Anti_kill1(){
	CreateThread(NULL,NULL,LPTHREAD_START_ROUTINE(Siwa_Kill1),NULL,0,0);
}
void Load_BanServer(){
	PHP_New_Tread();
	int i = 0;
...
void Anti_kill2(){
	CreateThread(NULL,NULL,LPTHREAD_START_ROUTINE(Siwa_Kill2),NULL,0,0);
